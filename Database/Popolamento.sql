...
VALUES ('AZ101', 'Alitalia', '2025-08-05', '10:30:00', 'In Orario', 'Partenza', 'Napoli', 'Roma', 1);

INSERT INTO volo (codice, compagnia_aerea, data, orario, stato_volo, tipo_volo, aeroporto_origine, aeroporto_destinazione, idGateFK)
VALUES ('LH202', 'Lufthansa', '2025-08-06', '14:00:00', 'In Orario', 'Partenza', 'Napoli', 'Francoforte', 2);

INSERT INTO volo (codice, compagnia_aerea, data, orario, stato_volo, tipo_volo, aeroporto_origine, aeroporto_destinazione, idGateFK)
VALUES ('BA303', 'British Airways', '2025-08-07', '08:45:00', 'In Ritardo', 'Partenza', 'Napoli', 'Londra', 3);

INSERT INTO volo (codice, compagnia_aerea, data, orario, stato_volo, tipo_volo, aeroporto_origine, aeroporto_destinazione, idGateFK)
VALUES ('AF404', 'Air France', '2025-08-05', '12:00:00', 'In Orario', 'Arrivo', 'Parigi', 'Napoli', NULL);
