...
ALTER TABLE prenotazione
ADD CONSTRAINT CHK_Prenotazione_Stato CHECK (stato_prenotazione IN ('Confermata', 'In Attesa', 'Cancellata'));
...
ALTER TABLE volo
ADD CONSTRAINT CHK_Volo_Stato CHECK (stato_volo IN ('Programmato', 'In Ritardo', 'Atterrato', 'Cancellato'));
